...
```bash
git clone https://github.com/nguyenanhdung2173/Chat-PDF
cd Chat-PDF
pip install -r requirements.txt
streamlit run app.py
```

Nếu là người sử dụng hoặc chỉ đơn giản là thử nghiệm hiệu quả, hãy thử demo của chúng tôi [tại đây](https://chat-with-pdf-21703.streamlit.app/)
